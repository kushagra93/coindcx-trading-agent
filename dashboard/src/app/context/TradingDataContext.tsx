...
export function TradingDataProvider({ children }: { children: ReactNode }) {
  ...
  const value: TradingDataState = useMemo(() => ({
    ...
    chains,
    allTokens,
  }), [holdings, perpHoldings, signals, recentTrades, portfolio, agents, events, auditLog, helpers, brokers, leaderboard, strategies, addTradeEvent, addAuditEntry, chains, allTokens]);
