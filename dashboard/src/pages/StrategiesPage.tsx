    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          ...
          <p style={{ color: '#64748b', fontSize: 13, marginTop: 4 }}>Manage your auto-trading strategies</p>
        </div>
            ...
            {templates.map(t => (
              <Card key={t.id} hoverable onClick={() => setShowTemplates(false)} style={{ cursor: 'pointer' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ fontSize: 11, color: '#64748b' }}>Sim. 90d return</div>
                  <div style={{ fontWeight: 700, color: '#22c55e' }}>{t.sim90d}</div>
                </div>
              </Card>
            ))}
          </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontWeight: 600 }}>${s.budget.toLocaleString()}</div>
                </div>
                ...
                <div style={{ display: 'flex', gap: 4 }}>
                  ...
                  <Button variant="ghost" size="sm" style={{ color: '#ef4444' }}><Trash2 size={14} /></Button>
                </div>
              </div>
            </div>
          </Card>
