...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    database: {
      ...
      enabled: !!envOrDefault('DATABASE_URL', ''),
      maxConnections: parseInt(envOrDefault('DB_MAX_CONNECTIONS', '10')),
    },
    ...
    gateway: {
      jwtSecret: nodeEnv === 'production'
        ? envOrThrow('GATEWAY_JWT_SECRET')
        : envOrDefault('GATEWAY_JWT_SECRET', 'dev-secret-change-in-production'),
    },
  };
}
